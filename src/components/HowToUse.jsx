...
const HowToUse = () => {
    ...
    const popover = (<Popover id="popover-basic">
        ...
        <Popover.Body>
            In the search bar to the right, you can search for deep sky objects from the Messier Catalogue by their Messier number e.g M1, or by their name if they have one. <br />
